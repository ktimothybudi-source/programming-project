 ...
 * walkFrames / walkFrameCount reserved if a multi-frame walk cycle is re-enabled.
 */
...
typedef struct Player {
    ...
    Texture2D walkFrames[PLAYER_WALK_FRAMES];
    int walkFrameCount; /* 0: use spriteLeft/spriteRight from assets/player_*.png */
    int animFrame;
    float animAccum;
